    ...
    <section class="px-6 py-8">
         <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
             ...
             <form method="POST" action="{{ route('register.store') }}" class="mt-8">
                 @csrf
                 <div class="mb-6">
                     <label for="name" class="block mb-2 mt-3 uppercase font-bold text-xs text-gray-700">
                         Name
                     </label>
                     ...
                     <label for="username" class="block mb-2 mt-3 uppercase font-bold text-xs text-gray-700">
                         Username
                     </label>
